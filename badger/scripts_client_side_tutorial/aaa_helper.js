...
const d_HasPlayerApproachedPiglinBaseANumberOfTimesThisSession = function (quantity) {
  return { name: "HasPlayerApproachedPiglinBaseThisSession", quantity: quantity };
};
...
const d_HasThePlayerPlacedAnyBuildableANumberOfTimes = function(quantity) {
  return { name: "HasThePlayerPlacedAnyBuildableANumberOfTimes", quantity: quantity };
};
...
const d_HasPlayerUsedAdvancedDirectANumberOfTimesThisSession = function(quantity) {
  return {
    name: "HasPlayerUsedAdvancedDirectANumberOfTimesThisSession",
    amount: quantity ? quantity : 0
  }
};

const SONGBOOK_PAGE_RESOURCING_MELODIES = 0;
const SONGBOOK_PAGE_COMBAT_MELODIES = 1;
const SONGBOOK_PAGE_PLAYER_BUILDING_MELODIES = 2;
const SONGBOOK_PAGE_IMPROVEMENTS_AND_HOST_MELODIES = 3;

const d_HasPlayerTurnedToSongbookPageEnoughTimes = function(pageIndex, quantity) {
  return {
    name: "HasPlayerTurnedSongbookToAParticularPageThisSession",
...
const d_HasPlayerSprintedANumberOfTimesThisSession = function(quantity) {
  return {
    name: "HasPlayerSprintedANumberOfTimesThisSession",
    quantity: quantity
  }
};

const d_IsThePlayerCurrentlySprinting = function() {
  return {
    name: "IsThePlayerCurrentlySprinting"
  }
}
...
const HasPlayerApproachedPiglinBaseANumberOfTimesThisSession = d_HasPlayerApproachedPiglinBaseANumberOfTimesThisSession;
...
const HasThePlayerPlacedAnyBuildableANumberOfTimes = d_HasThePlayerPlacedAnyBuildableANumberOfTimes;
...
const HasPlayerTurnedToSongbookPageEnoughTimes = d_HasPlayerTurnedToSongbookPageEnoughTimes;
const HasPlayerSprintedANumberOfTimesThisSession = d_HasPlayerSprintedANumberOfTimesThisSession;
const IsThePlayerCurrentlySprinting = d_IsThePlayerCurrentlySprinting;
const HasPlayerUsedAdvancedDirectANumberOfTimesThisSession = d_HasPlayerUsedAdvancedDirectANumberOfTimesThisSession;